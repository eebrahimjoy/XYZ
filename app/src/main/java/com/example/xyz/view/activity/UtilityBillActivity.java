...
public class UtilityBillActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        stringsBengali.add("Deep, tube,well, E-Bill,(Chottogram , Wasa)");
        stringsBengali.add("Desko Meter Reading");
        ...
        stringsBengali.add("Online Vesel Bill, (Bondor Bohirvurto Network, Chottogram Bondhor Kortipokkho)");
        stringsBengali.add("Desko Onumudito Payment Kendro");
        stringsBengali.add("Online Payment, (Khoolna Unnoyon Kortipokkho)");
        stringsBengali.add("Internet Bill Payment, (Biddhot , Jalanee Ebong Khoneej Sompodh Montronaloy)");
