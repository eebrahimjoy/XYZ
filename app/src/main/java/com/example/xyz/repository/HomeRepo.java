...
public class HomeRepo {
    ...
    public List<Company> getCompanies() {
        ...
        computerProducts.add(new Product("100"));
        computerProducts.add(new Product("90"));
        computerProducts.add(new Product("80"));
        computerProducts.add(new Product("70"));
        computerProducts.add(new Product("60"));
        computerProducts.add(new Product("50"));
        computerProducts.add(new Product("40"));
        computerProducts.add(new Product("30"));
        computerProducts.add(new Product("20"));
        computerProducts.add(new Product("10"));
        computerProducts.add(new Product("0"));
        computerProducts.add(new Product("-10"));
        computerProducts.add(new Product("-20"));
        computerProducts.add(new Product("-30"));
        computerProducts.add(new Product("-40"));
